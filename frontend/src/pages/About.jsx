...
const features = [
  ...
  { icon:'🧠', title:'RAG Training (Admin)',         accent: FEATURE_ACCENTS[3], desc:'Admins can train the chatbot with custom knowledge chunks — leave policies, seasonal patterns, role behaviours — to improve prediction context.'                                                         },
